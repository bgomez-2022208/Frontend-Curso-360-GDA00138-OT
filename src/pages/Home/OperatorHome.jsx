...
import { orderService, actualizarOrdenEstado } from '/src/services/OrderService.js';
...
export default function OperatorHome() {
    ...
    const handleAccept = async (idOrden) => {
        try {
            const response = await actualizarOrdenEstado(idOrden);
                        ...
                        <TableHead>
                            {rol === 1 ? (
                                <TableRow>
                                    ...
                                    <TableCell sx={{ fontWeight: 'bold' }}>Aceptar Orden</TableCell>
                                </TableRow>
                            ) : (
                                <TableRow>
                                    <TableCell />
                                            ...
                                            <>
                                                ...
                                                <TableCell>
                                                    <Button
                                                        variant="contained"
                                                        sx={{
                                                            backgroundColor: order.ordenEstado === 1 ? 'green' : order.ordenEstado === 2 ? 'red' : 'default',
                                                            color: 'white',
                                                            '&:hover': {
                                                                backgroundColor: order.ordenEstado === 1 ? 'darkgreen' : order.ordenEstado === 2 ? 'darkred' : 'default',
                                                            },
                                                        }}
            ...
            <Dialog open={!!openDialog} onClose={handleCloseDialog} maxWidth="md" fullWidth>
                ...
                <DialogContent dividers>
                    {orderDetails ? (
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sm={6}>
                                <Typography variant="body1"><strong>Nombre:</strong> {orderDetails.usuario}</Typography>
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <Typography variant="body1"><strong>Email:</strong> {orderDetails.correo}</Typography>
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <Typography variant="body1"><strong>Fecha de Entrega:</strong> {orderDetails.fechaEntrega}</Typography>
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <Typography variant="body1"><strong>Telefono:</strong> {orderDetails.telefono}</Typography>
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <Typography variant="body1"><strong>Direccion:</strong> {orderDetails.direccion}</Typography>
                            </Grid>
                            <Grid item xs={12}>
                ...
                <DialogActions>
                    ...
                    <Button
                        ...
                        color="primary"
                        disabled={orderDetails?.ordenEstado === 2}
                    >
                        Confirmar
                    </Button>
                </DialogActions>
